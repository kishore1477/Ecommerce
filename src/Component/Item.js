...
<section className="text-gray-600 body-font overflow-hidden" style={{userSelect: 'auto'}}>
  <div className="container px-5 py-24 mx-auto" style={{userSelect: 'auto'}}>
    <div className="lg:w-4/5 mx-auto flex flex-wrap" style={{userSelect: 'auto'}}>
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 rounded" src={dataP.image} style={{userSelect: 'auto'}} />
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" style={{userSelect: 'auto'}}>
        ...
        <p className="leading-relaxed" style={{userSelect: 'auto'}}>{dataP.description}</p>
        ...
        <div className="flex" style={{userSelect: 'auto'}}>
          ...
          <Link  to ={`/checkout/${dataP.id}`} className ="text-decoration-none text-dark">
          ...
          <button className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 mx-0 focus:outline-none hover:bg-indigo-600 rounded" style={{userSelect: 'auto'}} onClick ={handleShow}>Add to Cart</button>
        <Offcanva show ={show} handleClose ={handleClose} price ={dataP.price} title ={dataP.title}/>
        </div>
      </div>
    </div>
  </div>
